// feature/auht/presentation/page/doctor_registeration.dart
...
import 'package:se7ety_123/feature/auht/presentation/page/doctor_welcome.dart';
    ...
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is DoctorRegistionSuccessState) {
          ...
          pushReplacement(context, const DoctorWelcome());
          log("Success");
