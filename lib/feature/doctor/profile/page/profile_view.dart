...
class DocotrProfile extends StatefulWidget {
  const DocotrProfile({super.key});

  @override
  _DocotrProfileState createState() => _DocotrProfileState();
}

class _DocotrProfileState extends State<DocotrProfile> {
  String? _imagePath;
  File? file;
  String? profileUrl;
